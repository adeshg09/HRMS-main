...
export const PrimaryLink: any = tw(NavLink)`
  ...
  hocus:bg-gray-700 hocus:text-gray-200 focus:outline
  border-b-0
`;

export const LogoLink: any = styled(NavLink)`
...
// export const NavToggle: any = tw.button`
...
export default ({
  ...
  const collapseBreakpointCss: any =
